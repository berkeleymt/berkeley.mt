...
<div id="mc_embed_signup">
    <form action="https://berkeley.us7.list-manage.com/subscribe/post?u=24d4cef68c36baccb820775ad&amp;id=385ee9d1d1&amp;f_id=001dd0e4f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate !m-0" target="_self" novalidate="">
        <div id="mc_embed_signup_scroll">
            <div class="mc-field-group !w-full"><label for="mce-EMAIL">Email Address <span class="asterisk">*</span></label>
                <div class="flex flex-col sm:flex-row gap-3 sm:items-stretch">
                    <input type="email" name="EMAIL" class="required email !w-full sm:!flex-1 !border !border-gray-400 !rounded" id="mce-EMAIL" required="" value="">
