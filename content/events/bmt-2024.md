...
Due to room constraints, we can accommodate a maximum of 1,000 students for BMT
2024. Registration is first-come-first-serve. While we don't expect to reach
this limit in Phase 1, we encourage coaches to register as soon as possible to
guarantee space.

As of September 24, 2024, approximately 500 out of 1,000 seats have been filled.
{% end %}
...
opportunity to win prizes! Below are some of the activities we expect to run:
