...
Registration will open on **Monday, September 16 at 12:01 AM PT**. This year,
...
for a fee waiver. We will not honor refunds during the Adjustment period.
...
found here: [ContestDojo Guide](TODO).
...
- Students do not have to be local to the California Bay Area or the U.S. to
  participate in BMT. However, we do run iterations of BMT that may be a better
  fit for some students. Please see [Satellites](TODO) for other options.
...
This year, to streamline the event, we have a new automatic tiebreaker policy,
...
walk from home rooms) and downtown (~15 minute walk from home rooms).
...
[Team-Finder]: https://docs.google.com/spreadsheets/d/1i1RW4OTW8qP2Sb2GZd2gGTuP8Rusd-8bv-gJiRrODhI/edit?usp=sharing
