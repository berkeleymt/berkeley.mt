...
The team has worked some magic and we can now accommodate a maximum of 
**1,050** students for BMT 2024. Registration is first-come-first-serve, so
if you would like to attend we *strongly* encourage you to register now to
guarantee space.

As of October 5, 2024, approximately 1,015 out of 1,050 seats have been filled.
{% end %}
