...
just across the bay from San Francisco. The Berkeley campus is a 5 to 10 minute
walk from the Downtown Berkeley BART transit station, which connects directly to
both the Oakland and San Francisco International Airports. Berkeley is also easily
...
around contest weekend. 

A map of campus can be found [here](https://www.berkeley.edu/map-pdf/campusmap.pdf).
Note that the top of this map represents the eastern parts of campus. Google Maps is
also usually reliable for navigating campus.
