...
{% button_link(href="https://contestdojo.com/", muted=true, note="BMT 2026 isn't listed yet — you can create an account now") %} Registration Portal {% end %}
...
As in past years, we expect registration to take place in multiple phases to
give smaller organizations an opportunity to register.
